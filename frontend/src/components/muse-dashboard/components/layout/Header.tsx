...
const items = [
  {
    key: "New message from Sophie",
    label: <>{clockicon} 2 days ago</>,
    avatar: avtar,
  },
  {
    key: "New album by Travis Scott",
    label: <>{clockicon} 2 days ago</>,
        ...
        <Col span={24} md={18} className="header-control">
          {/* <Badge size="small" count={4}>
            <Dropdown menu={{ items }} dropdownRender={(menu: any) => (
              <List.Item>
                <List.Item.Meta
                  avatar={<Avatar shape="square" src={menu.avatar} />}
                  title={menu.key}
              ...
              <div className="sidebar-color">
                ...
                <div className="sidebarnav-color mb-2">
                  ...
                  <ButtonContainer className="trans">
                    <Button
                      type={sidenavType === "transparent" ? "primary" : "ghost"}
                      onClick={() => {
                    ...
                    <Button
                      type={sidenavType === "white" ? "primary" : "ghost"}
                      onClick={() => {
